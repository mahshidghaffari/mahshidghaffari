...
Frontend Engineer with building production Vue and Nuxt applications experience, specializing in complex state architecture, performance-critical UIs, and integrating AI/LLM capabilities into user-facing products.
...
- **Most active weekdays:** `git log --date=format:'%A' --pretty=format:'%ad' | sort | uniq -c | sort -nr`
- **Commit count by author in this repo:** `git shortlog -sn --all`
